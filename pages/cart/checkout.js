import styles from '../../styles/main/payment_lifetime.module.scss'
...
import CartItemCheckout from '../../components/pages/cart/CartItemCheckout';
import { formatPrice } from '../../utils/helper';
import Breadcrumb from '../../components/pages/cart/Breadcrumb'
import ProgressLifetime from '../../components/pages/cart/ProgressLifetime';
...
const Index = ( props ) =>
{
    ...
    useEffect( () =>
    {
        axios.post( 'page/cart/lifetime/checkout', { isUseCoin, voucher } ).then( response =>
        {
    ...
    const handleOrder = () =>
    {
        ...
        axios.post( 'page/cart/lifetime/order', { isUseCoin, voucher } ).then( response =>
        {
        ...
        <div className={ styles.container }>
            ...
            <AuthUser>
                <div className={ styles.cart_page }>
                    ...
                    <ProgressLifetime styles={styles} data={data} />
                    ...
                    <div className={ styles.boxes_1 }>
                            ...
                            <div className={ styles.items_3 }>
                                {
                                    data?.cart?.cartItems?.map( ( e, i ) => (
                                        <CartItemCheckout key={ e.id } data={ e } styles={ styles } />
                                    ) )
                                }
                            </div>
                        ...
                        <div className={ styles.right_2 }>
                            ...
                            <div className={ styles.items_mb_3 }>
                                {
                                    data?.cart?.cartItems?.map( ( e, i ) => (
                                        <CartItemCheckout key={ e.id } data={ e } styles={ styles } mobile={ true } />
                                    ) )
                                }
                            </div>
                                ...
                                <div className={ styles.body_4 }>
                                    <div className={ styles.row_5 }>
                                        <div className={ styles.col_6 }>
                                            Tổng đơn hàng ({ data?.cart?.cartItems?.length } sản phẩm)
                                        </div>
                                        <div className={ styles.col_6 }>
                                            { data?.cart?.subtotal.format( 0, 3, '.' ) } VNĐ
                                        </div>
                                    </div>
                                    <div className={ styles.row_5 }>
                                        <div className={ styles.col_6 }>
                                    ...
                                    <div className={ styles.row_5 }>
                                        ...
                                        <div className={ styles.col_6 }>
                                            { ( data?.cart?.discountByVoucher || 0 ).format( 0, 3, '.' ) } VNĐ
                                        </div>
                                    </div>
                                    <div className={ styles.row_5 }>
                                        <div className={ styles.col_6 }>
                                    ...
                                    <div className={ styles.row_5 }>
                                        ...
                                        <div className={ styles.col_6 }>
                                            { ( data?.cart?.subtotal * ( 100 - data?.cart?.discount || 0 ) / 100 - data?.cart?.discountByAimCoin - data?.cart?.discountByVoucher ).format( 0, 3, '.' ) } VNĐ
                                        </div>
                                    </div>
                                </div>
                            </div>
