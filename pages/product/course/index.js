...
import Product from '../../../components/global/ProductCourse'
...
const Index = ( props ) =>
{
    ...
    const { course, courseCategory, staticContent, seo } = props.data
    ...
    return (
        <div className={ styles.container }>
            ...
            <div className={ styles.products_page } >
                ...
                <Pagination lastPage={ course?.last_page } styles={ styles } />
...
export async function getServerSideProps ( context )
{
    ...
    await fetch( process.env.API_URL + 'page/product/course?page=' + context.query.page || 1, {
        method: 'POST',
        body: JSON.stringify( {
