...
const DiscountBySessionMb = ( { styles, data } ) =>
{
    ...
    return (
        <div className={ styles.discount_mb_3 }>
            {
                data?.discountBySession?.map( ( e, i ) =>
                {
                    ...
                    {
                        return (
                            <div className={ styles.col1_4 } key={ i } hidden={ i != nextDiscount }>
                                Giảm ngay { e?.value }%
                            </div>
                        )
                    }
...
export default DiscountBySessionMb