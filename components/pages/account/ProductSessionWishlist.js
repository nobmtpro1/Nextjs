...
const ProductSessionWishlist = ( { data, styles, unwishlist } ) =>
{
    ...
    return (
        <>
            <div className={ styles.item }>
                <div className={ styles.unwishlist } onClick={ () => unwishlist( 'session', data?.id ) }>
                ...
                <div className={ styles.elearning_buttons }>
                    <div className={ styles.left }>
                        <a href='#' className={ styles.add_to_cart } onClick={ () => handleAddToCart( data.id ) }>
                            <div className={ styles.image }>
                        ...
                        <a href='#' className={ styles.buy_now } onClick={ () => handleBuyNow( data.id ) }>
                            Mua ngay
                        </a>
                    </div>
...
export default ProductSessionWishlist
