...
import { BUSINESS_NOTIFICATION, BUSINESS_UPDATE_ACCOUNT, CART_MEMBERSHIP, HOME, PRODUCT_SESSION } from '../../../constants/route'
    ...
    return (
        <div className={ styles.header } >
            ...
            <div className={ styles.right }>
                <div className={ styles.cart } onClick={ () => router.push( CART_MEMBERSHIP ) }>
                ...
                <div className={ styles.cart } onClick={ () => router.push( BUSINESS_NOTIFICATION ) }>
                    <div className={ styles.image }>
                ...
                <div className={ styles.account }>
                    ...
                    <div className={ styles.name } >
                        ...
                        <div className={ styles.popup }>
                            <div className={ styles.item } onClick={ () => router.push( BUSINESS_UPDATE_ACCOUNT ) }>
                                <div className={ styles.image }>
